...
class CodeGeass extends Component {
	constructor() {
		super();
		this.state = {
data: [],
...
submitted: false,
	...
	handleSubmit(event) {
		...
		fetch('http://localhost:8080/LoggedIn/anime/codegeass/score', {
method: 'POST',
...
componentDidMount() {
	const request = new Request('http://127.0.0.1:8080/LoggedIn/anime/codegeass');
	fetch(request)
...
render() {
	if (this.state.submitted){
		var a="/LoggedIn/" + this.props.uname + "/anime/codeGeass/score"
			return (<Redirect to={a}/>)
	}
	return (
			<div className="App">
			<header className="App-header">
			<h1 className="App-title">Welcome to CodeGeass</h1>
			</header>
