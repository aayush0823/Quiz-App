...
class USPolitics extends Component {
	constructor() {
		super();
		this.state = {
data: [],
...
submitted: false,
	...
	handleSubmit(event) {
		...
		fetch('http://localhost:8080/LoggedIn/politics/us/score', {
method: 'POST',
...
componentDidMount() {
	const request = new Request('http://127.0.0.1:8080/LoggedIn/politics/us');
	fetch(request)
...
render() {
	if (this.state.submitted){
		var a="/LoggedIn/" + this.props.uname + "/politics/us/score"
			return (<Redirect to={a}/>)
	}
	return (
			<div className="App">
			<header className="App-header">
			<h1 className="App-title">Welcome to US-Politics</h1>
			</header>
			<h2>From George Bush To Donald Trump , let's see how much you know</h2>
