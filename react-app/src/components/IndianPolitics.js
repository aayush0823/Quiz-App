...
class IndianPolitics extends Component {
	constructor() {
		super();
		this.state = {
data: [],
...
submitted: false,
	...
	handleSubmit(event) {
		...
		fetch('http://localhost:8080/LoggedIn/politics/indian/score', {
method: 'POST',
...
componentDidMount() {
	const request = new Request('http://127.0.0.1:8080/LoggedIn/politics/indian');
	fetch(request)
...
render() {
	if (this.state.submitted){
		var a="/LoggedIn/" + this.props.uname + "/politics/indian/score"
			return (<Redirect to={a}/>)
	}
	return (
			<div className="App">
			<header className="App-header">
			<h1 className="App-title">Welcome to Indian-Politics</h1>
			</header>
			<h2>From Nehru To Modi , let's see how much you know</h2>
			<div className="App">
			<header className="App-header">
